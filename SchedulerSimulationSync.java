...
class SharedResources {
    ...
    public static final ReentrantLock lock = new ReentrantLock();   //1
    ...
    public static final Semaphore cpuSemaphore = new Semaphore(1);  //2
...
class Process implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            SharedResources.cpuSemaphore.release();    //8
        }
    }
